            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="AddCourse" method="post">
                    <div class="form-group">
                      <label for="exampleInputName1">Course ID</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Course ID" name="courseid" required>
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputPassword4">Course Name</label>
                      <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Course Name" name="coursename" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Course Fee</label>
                      <input type="number" class="form-control" id="exampleInputEmail3" placeholder="Course Fee" name="coursefee" required>
                     </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Course Desc</label>
                      <textarea class="form-control" id="exampleTextarea1" rows="4" name="coursedesc" required></textarea>
                    </div>

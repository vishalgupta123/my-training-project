...
<body><%String userid=(String)session.getAttribute("userid");
...
try {
    ...
    ResultSet rs=stmt.executeQuery("select * from course where courseid in (select distinct(courseid) from courseenroll where id='"+userid+"')");

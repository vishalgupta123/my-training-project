<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%@ page import="newpackage.bean.Feedback"%>
...
<body>
<%
ArrayList<Feedback> userList = (ArrayList<Feedback>)request.getAttribute("result");
%>
 ...
 <%
 for (Feedback user : userList) {
%>

                       <tr><td><%=user.getFeedbackid()%></td>
